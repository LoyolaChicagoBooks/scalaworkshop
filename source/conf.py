# -*- coding: utf-8 -*-
#
# Scala for CS and DS documentation build configuration file, created by
...
#html_short_title = "Scala for CS and DS <release>"
...
htmlhelp_basename = 'ScalaCSDSdoc'
...
latex_documents = [
  ('index', 'ScalaCSDS.tex', u'Scala for Computer and Data Science',
...
man_pages = [
        ('index', 'scalacsds', u'Scala for Computer and Data Science',
...
texinfo_documents = [
        ('index', 'ScalaCSDS', u'Scala for Computer and Data Science',
   u'Konstantin Läufer and George K. Thiruvathukal', 'ScalaCSDS', 'Scala for Computer and Data Science.',
   'Miscellaneous'),
]
